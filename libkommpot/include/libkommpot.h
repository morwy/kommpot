...
namespace kommpot {
     ...
     * @attention this function should be called only once, after all other kommpot functions are
     * done.
     */
     ...
     */
    auto EXPORTED communication_type_to_string(const communication_type &type) noexcept
        -> std::string;
